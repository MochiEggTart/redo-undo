...
var mochiUndoRedo_1 = require("../mochiUndoRedo");
test("MochiUndoRedo Test", function () {
    var mochiUndoRedo = new mochiUndoRedo_1.MochiUndoRedo();
    var step1 = "One";
    var step2 = "Two";
    var step3 = "Three";
    // Get All Data
    ...
    expect(step3).toBe(mochiUndoRedo.getData().value);
    // 判斷Count與資料總數是否一致
    var allData = mochiUndoRedo.getDataList();
